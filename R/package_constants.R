...
SE$ACHIEVEMENT_IRI         <- "http://purl.obolibrary.org/obo/psdo_0000112"
SE$LOSS_CONTENT_IRI        <- "http://purl.obolibrary.org/obo/psdo_0000113"
SE$CONSEC_NEG_GAP_IRI      <- "http://example.com/slowmo#ConsecutiveNegativeGapContent"
SE$CONSEC_POS_GAP_IRI      <- "http://example.com/slowmo#ConsecutivePositiveGapContent"
