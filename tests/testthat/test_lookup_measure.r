...
test_that("measure can be looked up by id or value",{
  ...
  id_result <- lookup_measure("_:m1000", VA2_SPEK)
...
test_that("id can be looked up from measure identifier", {
  ...
  # These ids make assumptions about the order in which ids are assigned when reading spek
  expect_identical(short_result, "_:m1000")
  expect_identical(long_result, "_:m1002")
})
